...
if __name__ == "__main__":
    data_folder = "PE_cfRNA"  # "TEST_DATA_copy"  # "ROSMAP" #"BRCA
    ...
    featimp_list = cal_feat_imp(
        data_folder, model_folder_path, view_list, num_class, adj_parameter, dim_he_list
    )
    featimp_list_list.append(copy.deepcopy(featimp_list))

    summarize_imp_feat(featimp_list_list, topn=topn)
